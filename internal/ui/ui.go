...
func (ui *UI) initComponents() {
	ui.statusBar = tview.NewTextView().SetText("Model: " + "gpt-5" + " | " + "dir: " + "vogte" + " | " + " status: 🟢").SetTextStyle(tcell.StyleDefault.Background(tcell.ColorBlack)) // TODO
	ui.chatView = tview.NewTextArea().SetWrap(true)
	ui.chatView.SetBorder(false) // .SetTitle(" VOGTE ")
	ui.addLogo()
